...
export default function LoginSignupLayout() {
  ...
  return (
    <PagesContainer additionalStyles="flex justify-center items-center bg-gradient-to-t from-blue-900 via-blue-600 to-blue-400">
      <div className="w-fit h-[100px] hidden md:block absolute left-14 top-8">
        <h1 className="text-4xl md:text-2xl font-bold text-blue-100">
          NoteNest
        </h1>
      </div>
      <div className="w-[300px] md:w-[350px] h-fit border-0 rounded-2xl pt-5 pb-4 px-5 bg-blue-100">
        <div className="mb-5">
